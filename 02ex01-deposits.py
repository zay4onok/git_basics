...
def main(args):
    ...
    # yields for some common periods of times

    print('Income per 1 years', deposit(initial_sum, percent, fixed_period, 1))
    print('Income per 5 years', deposit(initial_sum, percent, fixed_period, 5))
    print('Income per 10 years', deposit(initial_sum, percent, fixed_period, 10))
    print('Income per 15 years', deposit(initial_sum, percent, fixed_period, 15))
